...
function pm_hope_theme_setup() {
	...
	include_once(trailingslashit( get_template_directory() ) . "includes/widget-facebook.php"); //facebook
...
function pm_ln_login_logo_url_title() {
	return esc_html__('Pulsar Media :: Interactive Design Studio', "localization");
}
...
function pm_ln_remove_footer_admin () {
	echo '<span id="footer-thankyou">'. esc_html__('Developed by', "localization") .' <a href="http://www.pulsarmedia.ca/" target="_blank">'. esc_html__('Pulsar Media', "localization") .'</a> :: '. esc_html__('Interactive Design Studio', "localization") .' - '. esc_html__('Visit our', "localization") .' <a href="https://github.com/PulsarMedia" target="_blank">'. esc_html__('GitHub account', "localization") . '</a> ' . esc_html__('for more FREE WordPress themes and plugins', 'localization');
}
...
if( !function_exists('pm_ln_check_for_theme_updates') ){
	...
	function pm_ln_check_for_theme_updates() {
		...
		$theme_update_checker = new ThemeUpdateChecker(
			'Hope-charity-theme',
			'http://updates.microthemes.ca/theme-updates/hope-theme-updater.php'
		);
                ...
                <div id="sidebar" class="wrapper-cell">
                    ...
                    <div class="sidebar_box themes_box">
                        ...
                        <div class="inside">
                            <ul>
                            	<li>
                                	<a href="http://demos.microthemes.ca/?product=hope" target="_blank" title="Hope WordPress Theme"><img src="http://microthemes.ca/images/theme-ads/hope.jpg" alt="Hope WordPress Themes"></a>
                                </li>
                                
                                <li>
                                	<a href="http://demos.microthemes.ca/?product=quantum" target="_blank" title="Quantum WordPress Theme"><img src="http://microthemes.ca/images/theme-ads/quantum.jpg" alt="Quantum WordPress Themes"></a>
                                </li>
                                
                                <li>
                                	<a href="http://demos.microthemes.ca/?product=vienna" target="_blank" title="Vienna WordPress Theme"><img src="http://microthemes.ca/images/theme-ads/vienna.jpg" alt="Vienna WordPress Themes"></a>
                                </li>
                                
                                <li>
                                	<a href="http://demos.microthemes.ca/?product=medical-link" target="_blank" title="Medical-Link WordPress Theme"><img src="http://microthemes.ca/images/theme-ads/medical-link.jpg" alt="Medical-Link WordPress Themes"></a>
                                </li>
                                
                                <li>
                                	<a href="http://demos.microthemes.ca/?product=energy" target="_blank" title="Energy WordPress Theme"><img src="http://microthemes.ca/images/theme-ads/energy.jpg" alt="Energy WordPress Themes"></a>
                                </li>
                                
                                <li>
                                	<a href="http://demos.microthemes.ca/?product=luxor" target="_blank" title="Luxor WordPress Theme"><img src="http://microthemes.ca/images/theme-ads/luxor.jpg" alt="Luxor WordPress Themes"></a>
                                </li>
                                
                                <li>
                                	<a href="http://demos.microthemes.ca/?product=moxie" target="_blank" title="Moxie WordPress Theme"><img src="http://microthemes.ca/images/theme-ads/moxie.jpg" alt="Moxie WordPress Themes"></a>
                                </li>
                                
                                <li>
                                	<a href="http://demos.microthemes.ca/?product=pro-cast" target="_blank" title="Pro-Cast WordPress Theme"><img src="http://microthemes.ca/images/theme-ads/pro-cast.jpg" alt="Pro-Cast WordPress Themes"></a>
                                </li>	
...
if( !function_exists('pm_ln_theme_wrapper_start') ) {
	...
	function pm_ln_theme_wrapper_start() {
		...
		if(is_product()){
			 echo '<div class="container pm_paddingVertical100"><div class="row">';  
		} else {
			
			 $enableShopSidebar = get_theme_mod('enableShopSidebar', 'off');
			
			 echo '<div class="container pm_paddingVertical100">';
			 	echo '<div class="row">';
					echo '<div class="span'. ($enableShopSidebar === 'on' ? '8' : '12') .'">';  
			...
			<?php
				...
				echo '
					...
					.pm-gallery-item-hover-btn:hover {
						border-color: transparent '.$primaryColor.' '.$primaryColor.' transparent  !important;	
					}
				...
				$navOpacity = get_theme_mod('navOpacity', 80);
				$navOpacityFinal = $navOpacity / 100; //divide this to convert value decimal
				
				echo '
					.pm_main_nav_container, .pm-quick-nav-container {
						background-color:rgba('.$navBGColors[0].','.$navBGColors[1].','.$navBGColors[2].', '.$navOpacityFinal.')!important;
					}
					.sf-menu ul {
						background-color:rgba('.$navBGColors[0].','.$navBGColors[1].','.$navBGColors[2].', '.$navOpacityFinal.')!important;	
					}
				...
				$pageTitleTransparency = get_theme_mod('pageTitleTransparency', 60);
				$pageTitleTransparencyFinal = $pageTitleTransparency / 100; //divide this to convert value decimal
				echo '
				.pm_page_title {
					background-color:rgba('.$pageTitleColors[0].','.$pageTitleColors[1].','.$pageTitleColors[2].', '.$pageTitleTransparencyFinal.')!important;
				}
				';
				
				$pageQuoteColor = get_option('pageQuoteColor', '#2E2E2E');
				$pageQuoteColors = pm_hope_hex2rgb($pageQuoteColor);
				$pageMessageTransparency = get_theme_mod('pageMessageTransparency', 60);
				$pageMessageTransparencyFinal = $pageMessageTransparency / 100; //divide this to convert value decimal
				echo '
					.pm_header_quote {
						background-color:rgba('.$pageQuoteColors[0].','.$pageQuoteColors[1].','.$pageQuoteColors[2].', '.$pageMessageTransparencyFinal.')!important;
					}
				';
				
				$breadcrumbBg = get_option('breadcrumbBg', '#2E2E2E');
				$breadcrumbColors = pm_hope_hex2rgb($breadcrumbBg);
				$pageBreadcrumbTransparency = get_theme_mod('pageBreadcrumbTransparency', 60);
				$pageBreadcrumbTransparencyFinal = $pageBreadcrumbTransparency / 100; //divide this to convert value decimal
				echo '
					.breadcrumbs, .woocommerce-breadcrumb {
						background-color:rgba('.$breadcrumbColors[0].','.$breadcrumbColors[1].','.$breadcrumbColors[2].', '.$pageBreadcrumbTransparencyFinal.')!important;
					}
				';
				...
				echo '
					header {
						'. (!empty($headerBackgroundImage) ? 'background-image:url('.$headerBackgroundImage.');' : '') .'
