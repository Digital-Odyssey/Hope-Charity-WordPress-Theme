			...
			$this->sections[] = array(
			  ...
			  array(
				...
				array(
					...
					'font-backup'   => true,    // Select a backup non-google font in addition to a google font
					'all_styles'    => true,    // Enable all Google Font style/weight variations to be added to the page
					'output'        => array('.cart_totals > h2', '.woocommerce-billing-fields > h3', '.woocommerce-additional-fields > h3', '#order_review_heading'), // An array of CSS selectors to apply this font style to dynamically
					'compiler'      => array('.cart_totals > h2', '.woocommerce-billing-fields > h3', '.woocommerce-additional-fields > h3', '#order_review_heading'), // An array of CSS selectors to apply this font style to dynamically
					'units'         => 'px', // Defaults to px
					'line-height'   => true,
					'word-spacing'  => true,  // Defaults to false
					'letter-spacing' => true,  // Defaults to false
			...
			$this->sections[] = array(
			  ...
			  'fields'    => array(
				...
				array(
					...
					'font-backup'   => true,    // Select a backup non-google font in addition to a google font
					'all_styles'    => true,    // Enable all Google Font style/weight variations to be added to the page
					'output'        => array('p', '.pm_single_post_comment_count', 'table'), // An array of CSS selectors to apply this font style to dynamically
					'compiler'      => array('p', '.pm_single_post_comment_count', 'table'), // An array of CSS selectors to apply this font style to dynamically
					'units'         => 'px', // Defaults to px
					'line-height'   => true,
					'word-spacing'  => true,  // Defaults to false
					'letter-spacing'=> true,  // Defaults to false
				...
				array(
					...
					'font-backup'   => true,    // Select a backup non-google font in addition to a google font
					'all_styles'    => true,    // Enable all Google Font style/weight variations to be added to the page
					'output'        => array('.pm_span_header h4', '.pm_image_panel_header h4', '.pm_span_header.pm_post > h4 > span > a', '.pm_span_header.pm_event > h4 > span > a'), // An array of CSS selectors to apply this font style to dynamically
					'compiler'      => array('.pm_span_header h4', '.pm_image_panel_header h4', '.pm_span_header.pm_post > h4 > span > a', '.pm_span_header.pm_event > h4 > span > a'), // An array of CSS selectors to apply this font style to dynamically
					'units'         => 'px', // Defaults to px
					'line-height'   => true,
					'word-spacing'  => true,  // Defaults to false
					'letter-spacing' => true,  // Defaults to false
