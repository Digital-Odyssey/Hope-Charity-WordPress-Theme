...
function event_tags() {
	...
	// create the array for 'labels'
    $labels = array(
		'name' => esc_html__( 'Event Tags', 'localization' ),
		'singular_name' => esc_html__( 'Event Tags', 'localization' ),
		'search_items' =>  esc_html__( 'Search Event Tags', 'localization' ),
		'popular_items' => esc_html__( 'Popular Event Tags', 'localization' ),
		'all_items' => esc_html__( 'All Event Tags', 'localization' ),
		'parent_item' => null,
		'parent_item_colon' => null,
		'edit_item' => esc_html__( 'Edit Event Tag', 'localization' ),
		'update_item' => esc_html__( 'Update Event Tag', 'localization' ),
		'add_new_item' => esc_html__( 'Add Event Tag', 'localization' ),
		'new_item_name' => esc_html__( 'New Event Tag', 'localization' ),
		'separate_items_with_commas' => esc_html__( 'Separate Event Tags with commas', 'localization' ),
		'add_or_remove_items' => esc_html__( 'Add or remove Event Tags', 'localization' ),
		'choose_from_most_used' => esc_html__( 'Choose from the most used Event Tags', 'localization' )
    );
	
    // register your Flags taxonomy
    register_taxonomy( 'event_tags', 'post_events', array(
