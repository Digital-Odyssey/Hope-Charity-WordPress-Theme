...
function add_events_metaoptions() {
	...
	add_meta_box( 
		...
		esc_html__('Event Details', 'viennatheme'),  //label
	...
	//Event organizer
	add_meta_box( 
		'pm_event_organizer_details_meta', //ID
		esc_html__('Event Organizer Details', 'viennatheme'),  //label
		'pm_event_organizer_details_meta_function' , //function
		'post_events', //Post type
		'normal', 
		'high' 
	);
	...
	//Venue details
	add_meta_box( 
		'pm_event_venue_details_meta', //ID
		esc_html__('Event Venue Details', 'viennatheme'),  //label
		'pm_event_venue_details_meta_function' , //function
		'post_events', //Post type
		'normal', 
		'high' 
	);
	...
	//Panel Header Info
	add_meta_box( 
		'pm_event_disable_featured_image_meta', //ID
		 esc_attr__( 'Disable Featured Image on post?', 'localization' ),  //label
		'pm_event_disable_featured_image_meta_function' , //function
		'post_events', //Post type
		//'normal', 
		'side' 
	);
...
function pm_event_date_meta_function($post) {
	...
	//echo '$pm_event_date_meta = ' . $pm_event_date_meta;
...
function pm_event_start_time_meta_function($post) {
	...
	//HTML code
	?>
    	<p><?php esc_html_e('Enter the start time for this event.', 'localization'); ?></p>	
...
function pm_event_end_time_meta_function($post) {
	...
	//HTML code
	?>
    	<p><?php esc_html_e('Enter the end time for this event.', 'localization'); ?></p>	
...
function pm_event_details_meta_function($post) {
	...
	?>
		...
		<p><?php esc_attr_e('Display Event Details?', 'localization'); ?></p>
        <select id="pm_event_details_display_meta" name="pm_event_details_display_meta" class="pm-admin-select-list">  
        	<option value="yes" <?php selected( $pm_event_details_display_meta, 'yes' ); ?>><?php esc_attr_e('Yes', 'localization') ?></option>
            <option value="no" <?php selected( $pm_event_details_display_meta, 'no' ); ?>><?php esc_attr_e('No', 'localization') ?></option>
        </select>    	
    
    	<p><?php esc_attr_e('Event Date','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_details_date_meta); ?>" name="pm_event_details_date_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Event Time','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_details_time_meta); ?>" name="pm_event_details_time_meta" class="pm-admin-text-field" />
...
function pm_event_organizer_details_meta_function($post) {
	...
	?>
		...
		<p><?php esc_attr_e('Display Organizer Details?', 'localization'); ?></p>
        <select id="pm_event_organizer_display_meta" name="pm_event_organizer_display_meta" class="pm-admin-select-list">  
        	<option value="yes" <?php selected( $pm_event_organizer_display_meta, 'yes' ); ?>><?php esc_attr_e('Yes', 'localization') ?></option>
            <option value="no" <?php selected( $pm_event_organizer_display_meta, 'no' ); ?>><?php esc_attr_e('No', 'localization') ?></option>
        </select>    	
    
    	<p><?php esc_attr_e('Organizer Name','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_organizer_name_meta); ?>" name="pm_event_organizer_name_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Organizer Phone','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_organizer_phone_meta); ?>" name="pm_event_organizer_phone_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Organizer Email','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_organizer_email_meta); ?>" name="pm_event_organizer_email_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Organizer Website','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_organizer_website_meta); ?>" name="pm_event_organizer_website_meta" class="pm-admin-text-field" />
...
function pm_event_venue_details_meta_function($post) {
	...
	?>
		...
		<p><?php esc_attr_e('Display Venue Details?', 'localization'); ?></p>
        <select id="pm_event_venue_display_meta" name="pm_event_venue_display_meta" class="pm-admin-select-list">  
        	<option value="yes" <?php selected( $pm_event_venue_display_meta, 'yes' ); ?>><?php esc_attr_e('Yes', 'localization') ?></option>
            <option value="no" <?php selected( $pm_event_venue_display_meta, 'no' ); ?>><?php esc_attr_e('No', 'localization') ?></option>
        </select>    	
    
    	<p><?php esc_attr_e('Venue Name','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_venue_name_meta); ?>" name="pm_event_venue_name_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Venue Address','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_venue_address_meta); ?>" name="pm_event_venue_address_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Venue City','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_venue_city_meta); ?>" name="pm_event_venue_city_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Venue State/Province','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_venue_state_meta); ?>" name="pm_event_venue_state_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Venue Zip/Postal code','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_venue_zip_meta); ?>" name="pm_event_venue_zip_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Venue Country','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_venue_country_meta); ?>" name="pm_event_venue_country_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Venue Phone','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_venue_phone_meta); ?>" name="pm_event_venue_phone_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Venue Email','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_venue_email_meta); ?>" name="pm_event_venue_email_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Venue Website','localization'); ?></p>
		<input type="text" value="<?php echo esc_attr($pm_event_venue_website_meta); ?>" name="pm_event_venue_website_meta" class="pm-admin-text-field" />
        
        <p><?php esc_attr_e('Google Map embed code (iframe only)','localization'); ?></p>        
        <textarea name="pm_event_venue_google_map_meta" class="pm-admin-textarea-field"><?php echo esc_html($pm_event_venue_google_map_meta); ?></textarea>
...
function pm_event_disable_featured_image_meta_function($post) {
	...
	?>
    	<p><?php esc_attr_e('Use this option to disable the featured image on the single post template.', 'localization'); ?></p>
        <select id="pm_event_disable_featured_image_meta" name="pm_event_disable_featured_image_meta" class="pm-admin-select-list">  
        	<option value="yes" <?php selected( $pm_event_disable_featured_image_meta, 'yes' ); ?>><?php esc_attr_e('Yes', 'localization') ?></option>
            <option value="no" <?php selected( $pm_event_disable_featured_image_meta, 'no' ); ?>><?php esc_attr_e('No', 'localization') ?></option>
        </select>
    <?php
...
function add_post_metaoptions() {
	...
	add_meta_box( 
		'pm_post_disable_featured_image_meta', //ID
		esc_html__( 'Disable Featured Image on post?', 'localization' ),
		'pm_post_disable_featured_image_meta_function' , //function
		'post', //Post type
		'side'
	);
...
function pm_post_disable_featured_image_meta_function($post) {
	
	// Use nonce for verification
    wp_nonce_field( 'theme_metabox', 'post_meta_nonce' );
	
	$pm_post_disable_featured_image_meta = get_post_meta( $post->ID, 'pm_post_disable_featured_image_meta', true );
	
	?>
    	<p><?php esc_attr_e('Use this option to disable the featured image on the single post template.', 'localization'); ?></p>
        <select id="pm_post_disable_featured_image_meta" name="pm_post_disable_featured_image_meta" class="pm-admin-select-list">  
        	<option value="yes" <?php selected( $pm_post_disable_featured_image_meta, 'yes' ); ?>><?php esc_attr_e('Yes', 'localization') ?></option>
            <option value="no" <?php selected( $pm_post_disable_featured_image_meta, 'no' ); ?>><?php esc_attr_e('No', 'localization') ?></option>
        </select>
    <?php
...
function save_postdata( $post_id ) {
	...
	if(isset($_POST['post_meta_nonce'])){
		...
		if(isset($_POST['post-header-image'])){
			update_post_meta($post_id, "pm_header_image_meta", sanitize_text_field($_POST['post-header-image']));
		}		
		if(isset($_POST['pm_header_message_meta'])){
			update_post_meta($post_id, "pm_header_message_meta", sanitize_text_field($_POST['pm_header_message_meta']));
		}
	 
	 	if(isset($_POST['pm_post_layout_meta'])){
			update_post_meta($post_id, "pm_post_layout_meta", sanitize_text_field($_POST['pm_post_layout_meta']));
		}
		
		if(isset($_POST['pm_post_icon_meta'])){
			update_post_meta($post_id, "pm_post_icon_meta", sanitize_text_field($_POST['pm_post_icon_meta']));
		}
		
		if(isset($_POST['pm_post_tooltip_meta'])){
			update_post_meta($post_id, "pm_post_tooltip_meta", sanitize_text_field($_POST['pm_post_tooltip_meta']));
		}
		
		if(isset($_POST['pm_post_slide_transition_meta'])){
			update_post_meta($post_id, "pm_post_slide_transition_meta", sanitize_text_field($_POST['pm_post_slide_transition_meta']));
		}
		...
		if(isset($_POST["pm_post_disable_featured_image_meta"])){
			update_post_meta($post_id, "pm_post_disable_featured_image_meta", sanitize_text_field($_POST["pm_post_disable_featured_image_meta"]));
		}
		...
		if(isset($_POST['pm_page_layout_meta'])){
			update_post_meta($post_id, "pm_page_layout_meta", sanitize_text_field($_POST['pm_page_layout_meta']));
		}
		
		if(isset($_POST['pm_page_disable_container_meta'])){
			update_post_meta($post_id, "pm_page_disable_container_meta", sanitize_text_field($_POST['pm_page_disable_container_meta']));
		}
		...
		if(isset($_POST['pm_display_header_meta'])){
			update_post_meta($post_id, "pm_display_header_meta", sanitize_text_field($_POST['pm_display_header_meta']));
		}	
		...
		if(isset($_POST['pm_gallery_video_meta'])){
			update_post_meta($post_id, "pm_gallery_video_meta", sanitize_text_field($_POST['pm_gallery_video_meta']));
		}
		
		if(isset($_POST['pm_gallery_display_video_meta'])){
			update_post_meta($post_id, "pm_gallery_display_video_meta", sanitize_text_field($_POST['pm_gallery_display_video_meta']));
		}
		
		//Organizer values
		if(isset($_POST['pm_organizer_title_meta'])){
			update_post_meta($post_id, "pm_organizer_title_meta", sanitize_text_field($_POST['pm_organizer_title_meta']));
		}
		
		if(isset($_POST['pm_organizer_tooltip_meta'])){
			update_post_meta($post_id, "pm_organizer_tooltip_meta", sanitize_text_field($_POST['pm_organizer_tooltip_meta']));
		}
		
		if(isset($_POST['pm_organizer_contact_number_meta'])){
			update_post_meta($post_id, "pm_organizer_contact_number_meta", sanitize_text_field($_POST['pm_organizer_contact_number_meta']));
		}
		
		if(isset($_POST['pm_organizer_email_meta'])){
			update_post_meta($post_id, "pm_organizer_email_meta", sanitize_text_field($_POST['pm_organizer_email_meta']));
		}
		
		if(isset($_POST['pm_organizer_webiste_meta'])){
			update_post_meta($post_id, "pm_organizer_webiste_meta", sanitize_text_field($_POST['pm_organizer_webiste_meta']));
		}
		
		if(isset($_POST['pm_organizer_linkedin_meta'])){
			update_post_meta($post_id, "pm_organizer_linkedin_meta", sanitize_text_field($_POST['pm_organizer_linkedin_meta']));
		}
		
		if(isset($_POST['pm_organizer_twitter_meta'])){
			update_post_meta($post_id, "pm_organizer_twitter_meta", sanitize_text_field($_POST['pm_organizer_twitter_meta']));
		}
		
		if(isset($_POST['pm_organizer_facebook_meta'])){
			update_post_meta($post_id, "pm_organizer_facebook_meta", sanitize_text_field($_POST['pm_organizer_facebook_meta']));
		}
		
		if(isset($_POST['pm_organizer_google_meta'])){
			update_post_meta($post_id, "pm_organizer_google_meta", sanitize_text_field($_POST['pm_organizer_google_meta']));
		}
		
		if(isset($_POST['pm_organizer_skype_meta'])){
			update_post_meta($post_id, "pm_organizer_skype_meta", sanitize_text_field($_POST['pm_organizer_skype_meta']));
		}
		...
		if(isset($_POST['pm_event_tooltip_meta'])){
			update_post_meta($post_id, "pm_event_tooltip_meta", sanitize_text_field($_POST['pm_event_tooltip_meta']));
		}
		
		if(isset($_POST['pm_event_icon_meta'])){
			update_post_meta($post_id, "pm_event_icon_meta", sanitize_text_field($_POST['pm_event_icon_meta']));
		}
		
		if(isset($_POST['pm_event_countdown_meta'])){
			update_post_meta($post_id, "pm_event_countdown_meta", sanitize_text_field($_POST['pm_event_countdown_meta']));
		}
		
		if(isset($_POST['pm_event_panel_info_meta'])){
			update_post_meta($post_id, "pm_event_panel_info_meta", sanitize_text_field($_POST['pm_event_panel_info_meta']));
		}
		
		if(isset($_POST['pm_event_disable_featured_image_meta'])){
			update_post_meta($post_id, "pm_event_disable_featured_image_meta", sanitize_text_field($_POST['pm_event_disable_featured_image_meta']));
		}
		
		
		
		
		if(isset($_POST['pm_event_details_display_meta'])){
			update_post_meta($post_id, "pm_event_details_display_meta", sanitize_text_field($_POST['pm_event_details_display_meta']));
		}
		
		if(isset($_POST['pm_event_details_date_meta'])){
			update_post_meta($post_id, "pm_event_details_date_meta", sanitize_text_field($_POST['pm_event_details_date_meta']));
		}
		
		if(isset($_POST['pm_event_details_time_meta'])){
			update_post_meta($post_id, "pm_event_details_time_meta", sanitize_text_field($_POST['pm_event_details_time_meta']));
		}
		
		
		
		if(isset($_POST['pm_event_organizer_display_meta'])){
			update_post_meta($post_id, "pm_event_organizer_display_meta", sanitize_text_field($_POST['pm_event_organizer_display_meta']));
		}
		
		if(isset($_POST['pm_event_organizer_name_meta'])){
			update_post_meta($post_id, "pm_event_organizer_name_meta", sanitize_text_field($_POST['pm_event_organizer_name_meta']));
		}
		
		if(isset($_POST['pm_event_organizer_phone_meta'])){
			update_post_meta($post_id, "pm_event_organizer_phone_meta", sanitize_text_field($_POST['pm_event_organizer_phone_meta']));
		}
		
		if(isset($_POST['pm_event_organizer_email_meta'])){
			update_post_meta($post_id, "pm_event_organizer_email_meta", sanitize_text_field($_POST['pm_event_organizer_email_meta']));
		}
		
		if(isset($_POST['pm_event_organizer_website_meta'])){
			update_post_meta($post_id, "pm_event_organizer_website_meta", sanitize_text_field($_POST['pm_event_organizer_website_meta']));
		}
		...
		if(isset($_POST['pm_event_venue_display_meta'])){
			update_post_meta($post_id, "pm_event_venue_display_meta", sanitize_text_field($_POST['pm_event_venue_display_meta']));
		}
		
		if(isset($_POST['pm_event_venue_name_meta'])){
			update_post_meta($post_id, "pm_event_venue_name_meta", sanitize_text_field($_POST['pm_event_venue_name_meta']));
		}
		
		if(isset($_POST['pm_event_venue_address_meta'])){
			update_post_meta($post_id, "pm_event_venue_address_meta", sanitize_text_field($_POST['pm_event_venue_address_meta']));
		}
		
		if(isset($_POST['pm_event_venue_city_meta'])){
			update_post_meta($post_id, "pm_event_venue_city_meta", sanitize_text_field($_POST['pm_event_venue_city_meta']));
		}
		
		if(isset($_POST['pm_event_venue_state_meta'])){
			update_post_meta($post_id, "pm_event_venue_state_meta", sanitize_text_field($_POST['pm_event_venue_state_meta']));
		}
		
		if(isset($_POST['pm_event_venue_zip_meta'])){
			update_post_meta($post_id, "pm_event_venue_zip_meta", sanitize_text_field($_POST['pm_event_venue_zip_meta']));
		}
		
		if(isset($_POST['pm_event_venue_country_meta'])){
			update_post_meta($post_id, "pm_event_venue_country_meta", sanitize_text_field($_POST['pm_event_venue_country_meta']));
		}		
		
		if(isset($_POST['pm_event_venue_phone_meta'])){
			update_post_meta($post_id, "pm_event_venue_phone_meta", sanitize_text_field($_POST['pm_event_venue_phone_meta']));
		}
		
		if(isset($_POST['pm_event_venue_email_meta'])){
			update_post_meta($post_id, "pm_event_venue_email_meta", sanitize_text_field($_POST['pm_event_venue_email_meta']));
		}
		
		if(isset($_POST['pm_event_venue_website_meta'])){
			update_post_meta($post_id, "pm_event_venue_website_meta", sanitize_text_field($_POST['pm_event_venue_website_meta']));
		}
		
		if(isset($_POST['pm_event_venue_google_map_meta'])){
			update_post_meta($post_id, "pm_event_venue_google_map_meta", $_POST['pm_event_venue_google_map_meta']);
		}
