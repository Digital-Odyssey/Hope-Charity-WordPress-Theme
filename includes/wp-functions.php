		...
		if ((is_page() && !is_front_page()) || is_home() || is_category() || is_single() || is_tag() || is_404()) {
		 ...
		 if ($post_ancestors) {
			...
			foreach ($post_ancestors as $crumb){
				...
				echo '<li> &nbsp;&bull;&nbsp; <a href="'.get_permalink( $crumb ).'">'.get_the_title($crumb).'</a></li>';
			}
		 }
		 ...
		 //tag breadcrumb
		 if (is_tag()) {
			echo '<li> &nbsp;&bull;&nbsp; '.get_query_var('tag').'</li>';
			echo '</ul>';
		 }
		 
		 //tag breadcrumb
		 if (is_404()) {
			echo '<li> &nbsp;&bull;&nbsp; 404 Page Not Found</li>';
			echo '</ul>';
		 }
		 
		 //search breadcrumb
		 if (is_search()) {
			echo '<li> &nbsp;&bull;&nbsp; Search Results</li>';
			echo '</ul>';
		 }
		 //default breadcrumb
		 if ( is_page() ) {
			echo '<li> &nbsp;&bull;&nbsp; '.get_the_title().'</li>';
			echo '</ul>';
		 } 
		 ...
		 if( is_category() ) {
			 ...
			 $category = get_the_category();
			 echo '<li> &nbsp;&bull;&nbsp; <a href="'.get_category_link($category[0]->cat_ID).'">'.$category[0]->cat_name.'</a></li>';
			 echo '</ul>';
		 ...
		 if ( $post_type == 'post_events' || $post_type == 'post_organizers' ) {
			 ...
			 echo '<li> &nbsp;&bull;&nbsp; <a href="'.$post_type_link.'">'.$post_type_slug.'</a> &nbsp;&bull;&nbsp; '.get_the_title().'</li>';
		 ...
		 if ( $post_type == 'post_galleries' ) {
			 ...
			 echo '<li> &nbsp;&bull;&nbsp; '.$post_type_slug.' &nbsp;&bull;&nbsp; '.get_the_title().'</li>';
