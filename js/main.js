(function($) {
	...
	/* ==========================================================================
	   Event details google map toggle
	   ========================================================================== */
	    if($('#pm-toggle-event-google-map').length > 0){
			
			var targetHeight = $('.pm-event-info-google-map', '#pm-event-info-google-map').outerHeight();
			
			$('#pm-toggle-event-google-map').on('click', function(e) {
				...
				if( !$this.hasClass('active') ) {
					...
					//expand google map
					$('#pm-event-info-google-map').animate({
						height : targetHeight
					}, 500);
