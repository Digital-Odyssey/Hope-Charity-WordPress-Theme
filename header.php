...
<?php 
	...
	if($enableShopSidebar === 'on') {
		$woocommLayout = 'woocomm-right-sidebar';
	} else {
		$woocommLayout = 'woocomm-no-sidebar';
	}
...
<?php if($pageBackgroundImage != '') { ?>
		<body <?php body_class($woocommLayout); ?> style="background-image:url('<?php echo esc_html($pageBackgroundImage); ?>'); background-repeat:<?php echo $repeatBackground; ?>;" >
<?php } else { ?>
            	...
            	<?php if( function_exists( 'is_shop' ) || function_exists('is_product_category') || function_exists('is_product_tag') ) { //Woocommerce installed ?>
					...
					<?php if( is_shop() ) { ?>
                            ...
                            <?php if($pageHeaderImage !== '') { ?>
                                <div class="pm_subheader_container" style="background-image:url('<?php echo esc_url($pageHeaderImage); ?>');">
                            <?php } else { ?>
                                <div class="pm_subheader_container">
                            <?php } ?>
                    ...
                    <?php } elseif(is_single() || is_page()) { ?>
                            ...
                            <?php } elseif($globalHeaderImage2 !== '') { ?>
                                ...
                                <div class="pm_subheader_container" style="background-image:url('<?php echo esc_url($globalHeaderImage2); ?>');">
                    ...
                    <?php } else { ?>
                            ...
                            <?php if( is_404() || is_search() || is_tag() || is_category() || is_archive() ) { ?>
                                    ...
                                    <?php if($globalHeaderImage !== '') { ?>
                                        <div class="pm_subheader_container" style="background-image:url('<?php echo esc_url($globalHeaderImage); ?>');">
                                    <?php } else { ?>
                                        <div class="pm_subheader_container">
                                    <?php } ?>
                                ...
                                <?php if( is_shop() || is_product() || is_product_tag() || is_product_category() ) { ?>
                                 ...
                                 <?php } else { //end of if shopping pages ?>
                                        ...
                                        <?php } ?>
                                            ...
                                            <?php } elseif(is_tax('event_categories')) { ?>
                                            	<h2 class="pm_page_title"><?php _e('Events in', 'localization'); ?>: <?php single_tag_title(); ?></h2>                                            
                                        	<?php } elseif(is_tax('event_tags')) { ?>
                                            	<h2 class="pm_page_title"><?php _e('Events in', 'localization'); ?>: <?php single_tag_title(); ?></h2>                                            
                                            <?php } else { ?>
                                                <h2 class="pm_page_title"><?php the_title(); ?></h2>
                                            <?php } ?>
