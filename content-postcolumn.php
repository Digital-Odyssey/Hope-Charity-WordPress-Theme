<?php
/**
 * The default template for displaying blog post(s) with sidebar(s). Used for index/blog/archive/tags.
 */
?>
        ...
        <div class="pm-hover-item-spacer">
            ...
            <?php if($displaySocialMeta === 'on') : ?>
            	...
            	<ul class="pm-post-social-icons">
                    ...
                    <li class="facebook">
                    <a target="_blank" href="http://www.facebook.com/share.php?u=<?php the_permalink(); ?>"><i class="fa fa-facebook"></i></a>
                    </li>
                    
                    <li class="linkedin">
                    <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo site_url(); ?>&title=<?php the_title(); ?>" target="_blank"><i class="fa fa-linkedin"></i></a>
                    </li>
