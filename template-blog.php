...
<?php 
$blogTemplateLayout = get_theme_mod('blogTemplateLayout');
?>
<?php 
	//$headerimg = get_post_meta(get_the_ID(), 'headerimg', true);
	$disableSidebar = get_post_meta(get_the_ID(), 'disableSidebar', true);
?>
...
<div class="container pm_paddingVertical60 pm_posts">
    ...
    <?php if($disableSidebar == 'yes') { //render full screen content only ?>
